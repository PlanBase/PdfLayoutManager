...
import com.planbase.pdf.lm2.contents.WrappedTextTest
...
//        println("ascentDiff=$ascentDiff")
        ...
        lp.drawLine(Coord(0.0, yTop), Coord(lp.pageWidth(), yTop), LineStyle(RGB_BLACK, 0.125))
        lp.drawLine(Coord(0.0, top2), Coord(lp.pageWidth(), top2), LineStyle(PDColor(floatArrayOf(0.5f, 0.5f, 0.5f), PDDeviceRGB.INSTANCE), 0.125))
        lp.drawLine(Coord(0.0, yBaseline), Coord(lp.pageWidth(), yBaseline), LineStyle(RGB_BLACK, 0.125))
        lp.drawLine(Coord(0.0, yBottom), Coord(lp.pageWidth(), yBottom), LineStyle(RGB_BLACK, 0.125))
...
//        println("line3: " + wrappedLines[3])
    ...
    /**
     * Relies on [com.planbase.pdf.lm2.contents.TextLineWrapperTest.testTooLongWordWrapping] working.
     */
